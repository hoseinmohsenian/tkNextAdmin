...
function SiteNewsCategoriesCreatePage({ token, categoriesLevel1 }) {
    return (
        <div>
            <Header title="ایجاد دسته بندی دوم مقالات | تیکا"></Header>
            <AdminDashboard>
                <CreateCategory
                    token={token}
                    categoriesLevel1={categoriesLevel1}
                    title="ایجاد دسته بندی دوم مقالات"
...
export default SiteNewsCategoriesCreatePage;
