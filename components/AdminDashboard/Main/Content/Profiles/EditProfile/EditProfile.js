    ...
    const handleSubmit = async (e) => {
        ...
        if (
            ...
            for (const key in formData) {
                // Fields that don't need to be a part of loop
                if (
                    formData[key] &&
                    ![
                        "country_id",
                    ...
                    if (
                        ...
                        if (Number(formData[key]) !== student[key]) {
            ...
            if (selectedCountry.id && student.country_id) {
                fd.append("country_id", Number(selectedCountry.id));
            }
            if (selectedProvince.id && student.province_id) {
            ...
            if (
                selectedPreCode.id &&
                formData.mobile &&
                (selectedPreCode.id !== "STUDENT.PRECOE" ||
                    formData.mobile !== "STUDENT.MOBILE")
            ) {
                fd.append(
                    "mobile",
            ...
            if (
                ...
                (selectedPreCode2.id !== "STUDENT.PRECOE2" ||
