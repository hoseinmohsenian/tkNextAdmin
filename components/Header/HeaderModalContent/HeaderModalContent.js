...
function HeaderModalContent() {
    return (
        <>
            ...
            <div className="row">
                <div
                    className={`col-md-6 col-xs-12 ${styles["nav__modal-side"]}`}
                >
                    <a
                        href="tel:02191016620"
                        className={styles["nav__modal-side"]}
                    >
                        <div
                ...
                >
                    ...
                    >
                        <div className="nav__modal-icon nav__modal-wa"></div>
                        <div className="nav__modal-text">
                            <b>چت واتس اپ</b>
                            <span>09223231936</span>
                        </div>
                    </a>
                    <a
                        href="tel:02191016620"
